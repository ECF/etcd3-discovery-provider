...
public interface EventOrBuilder extends
   ...
   * @return The type.
   */
  org.eclipse.ecf.provider.etcd3.grpc.api.kv.Event.EventType getType();
   ...
   * @return The kv.
   */
  org.eclipse.ecf.provider.etcd3.grpc.api.kv.KeyValue getKv();
  /**
   * <pre>
   * kv holds the KeyValue for the event.
   * A PUT event contains current kv pair.
   ...
   * <code>.mvccpb.KeyValue kv = 2;</code>
   */
  org.eclipse.ecf.provider.etcd3.grpc.api.kv.KeyValueOrBuilder getKvOrBuilder();
