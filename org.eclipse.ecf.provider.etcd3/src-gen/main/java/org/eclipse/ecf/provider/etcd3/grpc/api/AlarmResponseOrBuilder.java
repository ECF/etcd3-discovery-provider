...
public interface AlarmResponseOrBuilder extends
   ...
   */
  java.util.List<org.eclipse.ecf.provider.etcd3.grpc.api.AlarmMember> 
      getAlarmsList();
  /**
   * <pre>
   * alarms is a list of alarms associated with the alarm request.
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  org.eclipse.ecf.provider.etcd3.grpc.api.AlarmMember getAlarms(int index);
  /**
   * <pre>
   * alarms is a list of alarms associated with the alarm request.
   * </pre>
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  java.util.List<? extends org.eclipse.ecf.provider.etcd3.grpc.api.AlarmMemberOrBuilder> 
