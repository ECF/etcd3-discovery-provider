...
public interface WatchCreateRequestOrBuilder extends
   ...
   */
  java.util.List<org.eclipse.ecf.provider.etcd3.grpc.api.WatchCreateRequest.FilterType> getFiltersList();
  /**
   * <pre>
   * filters filter the events at server side before it sends back to the watcher.
   * </pre>
   ...
   */
  org.eclipse.ecf.provider.etcd3.grpc.api.WatchCreateRequest.FilterType getFilters(int index);
  /**
   * <pre>
   * filters filter the events at server side before it sends back to the watcher.
   * </pre>
